...
<form method="post" action="checkIn" name='theForm' id="login_form">
  <input type="hidden" name="act" value="signin"/>
  <table cellspacing="0" cellpadding="0" style="margin-top: 100px" align="center">
  <tr>
    <td><img src="/shop/Public/images/login.png" width="178" height="256" border="0" alt="ECSHOP" /></td>
    <td style="padding-left: 50px">
      ...
      <img src="captcha" alt="CAPTCHA" style="cursor: pointer;" title="看不清？点击更换另一个验证码。" onclick="this.src='captcha'" />
      </td>
      </tr>
