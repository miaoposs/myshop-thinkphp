...
<link type="text/css" rel="stylesheet" href="/shop/Public/css/general.css">
...
<div id="header-div">
  <div style="bgcolor:#000000;" id="logo-div"><img alt="ECSHOP - power for e-commerce" src="/shop/Public/images/ecshop_logo.gif"></div>
  ...
  <div id="submenu-div">
    <div style="padding: 5px 10px 0 0; clear:right;text-align: right; color: #FF9900;width:40%;float: right;" id="send_info">
            <a class="fix-submenu" target="main-frame" href="/shop/index.php/Admin/MainMenu/clearCache">清除缓存</a>
      <a class="fix-submenu" target="_top" href="/shop/index.php/Admin/MainMenu/logout" name="">退出</a>
    </div>
        <div style="padding: 5px 10px 0pt 0pt; text-align: right; color: rgb(255, 153, 0); display: none; width: 40%; float: right;" id="load-div"><img width="16" height="16" style="vertical-align: middle" alt="正在处理您的请求..." src="/shop/Public/images/top_loader.gif"> 正在处理您的请求...</div>
  </div>
</div>
<div id="menu-div">
  <ul>
    <li class="fix-spacel">&nbsp;</li>
        <li class="fix-spacer">你好,<?php echo 'admin';?> 你上次的登录时间是：</li>
