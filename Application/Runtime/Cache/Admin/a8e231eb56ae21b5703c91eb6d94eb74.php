...
<table width="100%" cellspacing="1" cellpadding="2" id="list-table">
  ...
  <?php if(is_array($categories)): foreach($categories as $key=>$category): ?><tr align="center" class="0" id="0_6">
      <td align="left" class="first-cell" >
        <?php echo ($category['cat_id']); ?>
      </td>
      <td align="left" class="first-cell" >
        <?php echo str_repeat('&nbsp;', $category['level']*4); echo ($category['cat_name']); ?>
      </td>
      <td width="10%">
      ...
      <td width="24%" align="center">
        <a href="/shop/index.php/Admin/Category/showOperator/name/update/param/<?php echo ($category['cat_id']); ?>">编辑</a> |
        <a href="/shop/index.php/Admin/Category/deleteCategory/cat_id/<?php echo ($category['cat_id']); ?>" onclick="return confirm('你确定删除么?');" title="移除">移除</a>
      </td>
